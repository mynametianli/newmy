  ...
  export default{
    ...
    methods:{
      ...
      closeshow2:function(){
        this.$http({
          method:'put',
          url:'http://192.168.3.28:8888/work/close_declaration/',
          body:{
      ...
      setcustorm:function(){
        ...
        this.$http({
          method:'POST',
          url:'http://192.168.3.28:8888/work/add_declaration/',
          body:{
      ...
      getdate:function(startdate,enddate,page){
        this.$http({
          method:'get',
          url:'http://192.168.3.28:8888/work/get_declaration/?page='+page,
          params:{
            get_type:'search',
      ...
      searchstatusm:function(mstatus,page){
        this.$http({
          method:'get',
          url:'http://192.168.3.28:8888/work/get_declaration/',//192.168.3.28:8888
          params:{
            status:mstatus,
            page:page
          },
    ...
    beforeCreate:function(){
      this.$http({
        method:'get',
        url:'http://192.168.3.28:8888/work/get_declaration/?page=1',
        headers:{
          'Authorization':sessionStorage.getItem('token')
        }
      }).then( res => {
