  ...
  export default{
    ...
    methods:{
      ...
      getdate:function(startdate,enddate,page){
        this.$http({
          method:'GET',
          url:'http://192.168.3.28:8888/work_admin/get_declaration/?page='+page,
          params:{
            get_type:'search',
      ...
      close:function(){
        ...
        this.$http({
          method:'post',
          body:data,
          url:'http://192.168.3.28:8888/work_admin/appropriation/',
          headers:{
            'Authorization':sessionStorage.getItem('token')
          }
        }).then( res => {
    ...
    beforeCreate:function(){
      this.$http({
        method:'GET',
        url:'http://192.168.3.28:8888/work_admin/get_declaration/?page=1',
        headers:{
          'Authorization':sessionStorage.getItem('token')
        }
      }).then( res => {
