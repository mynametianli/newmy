  ...
  export default{
    ...
    methods:{
      getexcel:function(){
        this.$http({
          method:'GET',
          url:'http://192.168.3.28:8888/work_admin/export_works/',
          headers:{
      ...
      opendetail:function(tbm){
        ...
        this.$http({
          method:'GET',
          url:'http://192.168.3.28:8888/work_admin/work_declaration/',
          params:{
            user_id:tbm.id
          },
          headers:{
      ...
      setcustorm:function(){
        ...
        this.$http({
          method:'put',
          url:'http://192.168.3.28:8888/work_admin/change_work_wallet/',
          body:data,
          headers:{
            'Authorization':sessionStorage.getItem('token')
          }
     ...
     /* lockme:function(){
        if(this.islock){
          ...
          this.$http({
            method:'post',
            url:'http://192.168.3.28:8888/work_admin/user_active/',
            body:data,
            headers:{
              'Authorization':sessionStorage.getItem('token')
            }
      ...
      closepass:function(){
        ...
        this.$http({
          method:'put',
          url:'http://192.168.3.28:8888/work_admin/set_work/',
          body:data,
          headers:{
            'Authorization':sessionStorage.getItem('token')
          }
      ...
      getworld:function(data,page){
        this.$http({
          method:'GET',
          url:'http://192.168.3.28:8888/work_admin/get_all_user/',
          params:{
            get_type:'search',
            search_type:'24',
            word:data,
      ...
      getdetail:function(page){
        this.$http({
          method:'GET',
          url:'http://192.168.3.28:8888/work_admin/get_all_user/?page='+ page,
          params:{
            get_type:'24'
          },
          headers:{
    ...
    beforeCreate:function(){
      this.$http({
        method:'GET',
        url:'http://192.168.3.28:8888/work_admin/get_all_user/?page=1',
        params:{
          get_type:'24'
        },
        headers:{
