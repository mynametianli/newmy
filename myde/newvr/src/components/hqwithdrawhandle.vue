  ...
  export default{
    ...
    methods:{
      getdetail:function(page){
        this.$http({
          method:'GET',
          url:'http://192.168.3.28:8888/work_admin/get_withdraw/?type=2&page='+page,
          headers:{
      ...
      close:function(){
        this.$http({
          method:'POST',
          url:'http://192.168.3.28:8888/work_admin/set_withdraw/',
          body:{
            record_id:this.myid
          },
          headers:{
    ...
    beforeCreate:function(){
      this.$http({
        method:'GET',
        url:'http://192.168.3.28:8888/work_admin/get_withdraw/?page=1&type=2',
        headers:{
          'Authorization':sessionStorage.getItem('token')
        }
      }).then( res => {
