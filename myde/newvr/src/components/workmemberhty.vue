...
<script>
  export default{
    ...
    methods:{
     /* openremove:function(tbm){
      ...
      freeenter:function(){
        this.$http({
          method:'PUT',
          url:'http://192.168.3.28:8888/work/set_member/',
          body:{
      ...
      byword:function(word,page){
        this.$http({
          method:'GET',
          url:'http://192.168.3.28:8888/work/get_member/',
          params:{
            word:word,
            page:page
          },
      ...
      removemember:function(id){
        this.$http({
          method:'DELETE',
          url:'http://192.168.3.28:8888/work/del_member/',
          body:{
            member_id:id
          },
          headers:{
      ...
      getdetail:function(page){
        this.$http({
          method:'get',
          url:'http://192.168.3.28:8888/work/set_member_info/?page='+page,
          headers:{
            'Authorization':sessionStorage.getItem('token')
          }
        }).then(function(res){
    ...
    beforeCreate:function(){
      this.$http({
        method:'get',
        url:'http://192.168.3.28:8888/work/set_member_info/?page=1',
        headers:{
          'Authorization':sessionStorage.getItem('token')
        }
      }).then(function(res){
