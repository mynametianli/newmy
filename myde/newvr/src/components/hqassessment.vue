  ...
  export default{
    ...
    data(){
      return {
        ...
        tbtitle:['工作室名称','工作室等级','交易宝账号','当月业绩','历史业绩','操作','管理'],//table表头
        tbmsg:[
    ...
    methods:{
      ...
      operateok(){
        if(this.type === 'dissolve'){
          this.$http({
            method:'DELETE',
            url:'http://192.168.3.28:8888/work_admin/del_studio/',
            body:{
              work_id:this.workid
            },
            headers:{
          ...
          this.$http({
            method:'PUT',
            url:'http://192.168.3.28:8888/work_admin/set_level/',
            body:{
              work_id:this.workid,
