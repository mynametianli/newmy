...
<script>  export default{
    ...
    methods:{
      getexcel:function(){
        ...
        this.$http({
          method:'GET',
          url:'http://192.168.3.28:8888/work_admin/export_report/',
          headers:{
      ...
      getword:function(word,page){
        this.$http({
          method:'GET',
          url:'http://192.168.3.28:8888/work_admin/get_declaration/?type=1&page='+page,
          params:{
            get_type:'search',
            word:word
          },
    ...
    beforeCreate:function(){
      this.$http({
        method:'GET',
        url:'http://192.168.3.28:8888/work_admin/get_declaration/?page=1&type=1',
        headers:{
          'Authorization':sessionStorage.getItem('token')
        }
      }).then( res => {
